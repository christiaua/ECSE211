...
public class RingDetector {
  ...
  /**
   * Beeps 1, 2, 3, or 4 times depending on the colour. If this method has already been called
   * before for a ring colour, it does not beep.
   * 
   * @param colour Valid values for colour are 0 (blue), 1 (green), 2 (yellow), 3 (orange) for
   *        beeping one, two, three or four times respectively.
   */
  ...
  /**
   * Processes RGB data to determine whether a ring has been detected or not. If the RGB data
   * corresponds to a ring, the robot beeps a number of times depending on the colour of the ring
   * that has been detected. Beeps one time for blue, two times for green, three times for yellow
   * and four times for orange. Does not beep again if the ring has already been detected
   * previously.
   * 
