...
public class Navigation {
	 ...
	 * 
	 * @param distance
	 *            The distance to move. A negative distance implies going backwards.
	 * @param immediateReturn
	 *            To give immediate return or not.
	 */
	...
	public static void travelTo(double x, double y) {
		...
		while (true) {
			...
			if ((angleDif > 1 && angleDif < 20) || (angleDif > 350 && angleDif < 359)) {
				...
				Sound.beep();
				turnTo(angleToTurnTo);
				currentDistance = calculateDistance(x * TILE_SIZE, y * TILE_SIZE, currentPosition[0],
						currentPosition[1]);
				moveForward(currentDistance, true);
			}
	...
	/**
	 * This method calculates the angle which the robot has to turn to reach tile
	 * position x, y using the data from the odometer which is passed into the
	 * method.
	 * 
	 * @param x
	 *            The x position which is used to calculate the angle.
	 * @param y
	 *            The y position which is used to calculate the angle.
	 * @param odo
	 *            The odometer from which to obtain the robot's current position and
	 *            heading.
	 * @return The angle which the robot has to turn to reach tile position x, y
	...
	/**
	 * This method calculates the Euclidean distance given x, y initial and x, y
	 * final.
	 * 
	 * @param x1
	 *            The initial x.
	 ...
	 * 
	 * @param speed
	 *            The speed at which to set the motors to.
	 */
