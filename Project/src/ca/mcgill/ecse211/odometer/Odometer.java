...
/**
 * This class is the Odometer. It computes the x,y position and the angle of the robot based on how
 * much the wheels turned. This class should be ran on a separate thread so it
 * can always calculate how much the left and righ wheels turn.
 * 
 * @author Sophie Deng
 * @author Edris Jebran
 */
public class Odometer extends OdometerData implements Runnable {
	...
	public void run() {
		...
		while (true) {
			...
			distL = PIE * odo.WHEEL_RAD * (leftMotorTachoCount - lastTachoL) / 180;// odo.WHEEL_RAD is
																					// wheel radius
