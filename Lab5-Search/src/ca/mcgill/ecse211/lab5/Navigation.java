...
public class Navigation {
  ...
  public Navigation(EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor,
      EV3MediumRegulatedMotor sensorMotor, double radius, double track, UltrasonicController cont)
  ...
  public void travelToWhileSearching(double x, double y) {
    ...
    while (true) {
      ...
      // if in navigating mode, motors aren't moving and near the destination,
      // exit navigating mode
